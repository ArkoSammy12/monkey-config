...
sealed class ConfigElementBuilder<I : ConfigElement, T : ConfigElementBuilder<I, T>>(
    ...
    /**
     * An optional listener triggered whenever the [io.github.arkosammy12.monkeyconfig.base.ConfigManager] associated with the
    ...
    /**
     * Use this property to specify the actual [ConfigElement] implementation that will be used to build this [io.github.arkosammy12.monkeyconfig.builders.ConfigElementBuilder].
