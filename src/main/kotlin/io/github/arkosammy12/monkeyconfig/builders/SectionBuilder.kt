...
abstract class SectionBuilder<I : Section, A : SectionBuilder<I, A>>(
    ...
    /**
     * An immutable view of the [ConfigElementBuilder]s currently held by this [io.github.arkosammy12.monkeyconfig.builders.SectionBuilder].
    ...
    /**
     * Adds a new [Setting] to this [io.github.arkosammy12.monkeyconfig.builders.SectionBuilder] via its [SettingBuilder].
     *
    ...
    /**
     * Adds new a [Section] to this [io.github.arkosammy12.monkeyconfig.builders.SectionBuilder] via its [io.github.arkosammy12.monkeyconfig.builders.SectionBuilder].
     *
    ...
    /**
     * Adds a new [io.github.arkosammy12.monkeyconfig.sections.maps.MapSection] to this [io.github.arkosammy12.monkeyconfig.builders.SectionBuilder] via its [MapSectionBuilder].
     *
    ...
    /**
     * Adds a new [io.github.arkosammy12.monkeyconfig.sections.maps.StringMapSection] to this [io.github.arkosammy12.monkeyconfig.builders.SectionBuilder] via its [StringMapSectionBuilder].
     *
     * @param sectionName The name of the map section being added. It cannot contain "**.**".
