...
open class ConfigManagerBuilder(
    ...
    /**
     * An optional [Logger] instance accessible to the resulting [ConfigManager] and its [io.arkosammy12.monkeyconfig.base.ConfigElement]s.
     */
    open var logger: Logger? = null

    /**
     * A function which allows for different [ConfigManager] implementations to be used when building this [io.arkosammy12.monkeyconfig.builders.ConfigManagerBuilder].
     */
    open var implementation: (ConfigManagerBuilder) -> ConfigManager = ::DefaultConfigManager

    /**
     * An immutable view of the [ConfigElementBuilder]s currently held by this [io.arkosammy12.monkeyconfig.builders.ConfigManagerBuilder].
    ...
    /**
     * Adds a new [Setting] to this [io.arkosammy12.monkeyconfig.builders.ConfigManagerBuilder] via its [SettingBuilder].
     *
    ...
    /**
     * Adds new a [Section] to this [io.arkosammy12.monkeyconfig.builders.ConfigManagerBuilder] via its [io.arkosammy12.monkeyconfig.builders.SectionBuilder].
     *
    ...
    /**
     * Adds a new [io.arkosammy12.monkeyconfig.sections.maps.MapSection] to this [io.arkosammy12.monkeyconfig.builders.ConfigManagerBuilder] via its [MapSectionBuilder].
     *
    ...
    /**
     * Adds a new [io.arkosammy12.monkeyconfig.sections.maps.StringMapSection] to this [io.arkosammy12.monkeyconfig.builders.ConfigManagerBuilder] via its [StringMapSectionBuilder].
     *
     * @param sectionName The name of the map section being added. It cannot contain "**.**".
